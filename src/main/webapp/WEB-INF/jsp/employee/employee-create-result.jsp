...
<tags:_template>
	...
	<div class="container d-flex justify-content-around align-items-center">
		<div class="align-self-center">
			<c:choose>
				<c:when test="${status == 'was created'}">
				...
				<c:otherwise>
					<div class="d-flex justify-content-center">
						<div class="bg-danger border border-dark rounded p-4" style="max-width: 800px;">
							<p class="text-center text-wrap text-white">${erro}</p>
						</div>
					</div>
				</c:otherwise>
			</c:choose>
		...
		<div class="align-self-center">
			<a type="button" class="btn btn-secondary btn-lg" href="/employee/">Return to Employee</a>
		</div>
	</div>
</tags:_template>