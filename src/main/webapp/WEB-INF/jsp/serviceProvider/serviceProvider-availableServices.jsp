            ...
            <c:when test="${status == 'OK'}">
                <div>
                    <div class="d-flex bd-highlight mt-4">
                        <a type="button" class="btn btn-warning" href="/serviceProvider/${serviceProvider.id}">
                            RETURN
                        </a>
                                    ...
                                    <table class="table table-hover table-sm">
                                        <thead class="thead-dark">
                                            <tr class="row text-center text-white">
                                                <th scope="col" class="col-12">AVAILABLE SERVICES</th>
                                            </tr>
                                            <tr class="row">
                                        ...
                                        <tbody>
                                            <c:forEach var="item" items="${availableServices}">
